...
public class ClassLocatorForJarFiles implements ClassLocator {
    ...
    public Set<Class<?>> locateClasses(String directory) throws ClassLocationException {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                final String className = jarEntry.getName().replace(Constants.JAVA_BINARY_EXTENSION, "").replaceAll("\\\\", ".").replaceAll("/", ".");
